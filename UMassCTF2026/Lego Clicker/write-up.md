...
Tại đây ta nhìn thấy file `liblegocore.so`. Dùng IDA mở file này lên, đi vào [`JNI_Onload`](./JNI_Onload.c), ta thấy đoạn code đã tiết lộ 2 hành động chính của hệ thống:
